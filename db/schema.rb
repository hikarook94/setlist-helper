...
ActiveRecord::Schema[7.0].define(version: 2023_07_24_064945) do
  ...
  create_table "songs_setlists", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "song_id", null: false
    t.bigint "setlist_id", null: false
    t.integer "position", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["setlist_id"], name: "index_songs_setlists_on_setlist_id"
    t.index ["song_id"], name: "index_songs_setlists_on_song_id"
  end

  add_foreign_key "songs_setlists", "setlists"
  add_foreign_key "songs_setlists", "songs"
end
